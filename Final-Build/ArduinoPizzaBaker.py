...
def SendingStatus():
    ...
    localSignal = requests.post('http://127.0.0.1:5000/dashboard', json = LocalSignal)
    if localSignal.status_code == 200:
        print("Status_Sending")
    else:
        print("Status_Sending Failed", localSignal.status_code)
...
def setup():
    ...
    requests.post('http://127.0.0.1:5000/dashboard', json = {'SignalVal': 0})
